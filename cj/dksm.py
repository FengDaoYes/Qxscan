...
duankou = {"20":"ftp-data","21":"ftp服务[允许匿名的上传、下载、爆破和嗅探操作]","22":"ssh远程连接[爆破、SSH隧道及内网代理转发、文件传输、OpenSSL漏洞]","23":"telnet远程连接[爆破、嗅探、弱口令]","25":"smtp邮件服务[用户名枚举、邮件伪造]",
			...
			'5632':'PcAnywhere服务[抓取密码、代码执行、拒绝服务攻击、提权]','7001':'WebLogic控制台[Java反序列化、弱口令、命令执行]','7002':'WebLogic控制台[Java反序列化、弱口令]','8089':'http','9090':'WebSphere控制台[java反序列化、弱口令]',
			...
			'1099':'JAVA RMI[反序列化利用]','8500':"ColdFusion[文件读取漏洞]",'9043':"websphere[弱口令/admin/admin]",'9000':"fcigphp[代码执行]",'4440':'rundeck',
			'50060':'hadoop[未授权访问]','50070':'hadoop[未授权访问]','50030':'hadoop[未授权访问]','2601':'zebra[默认密码 zebra]','2604':'zebra[默认密码 zebra]'}
